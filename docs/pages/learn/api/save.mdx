...
`Save` allows for in-game data to persist between session, this can extremely useful for web gaming session. `Load` will allow this data to be retrieved either automically or manually.
